        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7 col-12">
                    <div class="hero-text">
                        <div class="hero-title-wrap d-flex align-items-center mb-4">
                            {{-- <img src="{{ asset('user/images/happy-bearded-young-man.jpg') }}"
                                class="avatar-image avatar-image-large img-fluid" alt=""> --}}

                            <h1 class="hero-title mb-0">Hello friend!</h1>
                        </div>

                        <h2 class="mb-4">I’m available for freelance work.</h2>
                        <p class="mb-4"><a class="custom-btn btn custom-link" href="#section_2">Let's begin</a>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-12 position-relative">
                    ...
                    <img src="{{ asset('user/images/portrait-happy-excited-man-holding-laptop-computer.png') }}"
